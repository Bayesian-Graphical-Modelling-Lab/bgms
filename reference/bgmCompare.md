...
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1128/2000 (56.4%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━⦘ 1075/2000 (53.8%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 4184/8000 (52.3%)
#> Elapsed: 55s | ETA: 50s
...
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1282/2000 (64.1%)
...
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 4980/8000 (62.3%)
#> Elapsed: 58s | ETA: 35s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1200/2000 (60.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1278/2000 (63.9%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1379/2000 (69.0%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━⦘ 1319/2000 (66.0%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 5176/8000 (64.7%)
#> Elapsed: 59s | ETA: 32s
...
#> Elapsed: 1m 1s | ETA: 27s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1350/2000 (67.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━⦘ 1425/2000 (71.2%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1526/2000 (76.3%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━⦘ 1464/2000 (73.2%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 5765/8000 (72.1%)
#> Elapsed: 1m 2s | ETA: 24s
...
#> Elapsed: 1m 2s | ETA: 21s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1450/2000 (72.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━⦘ 1524/2000 (76.2%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━⦘ 1625/2000 (81.2%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━⦘ 1564/2000 (78.2%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 6163/8000 (77.0%)
#> Elapsed: 1m 3s | ETA: 19s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1500/2000 (75.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━⦘ 1575/2000 (78.8%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━⦘ 1675/2000 (83.8%)
...
#> Elapsed: 1m 5s | ETA: 14s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1600/2000 (80.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1686/2000 (84.3%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1783/2000 (89.1%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━⦘ 1713/2000 (85.7%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 6782/8000 (84.8%)
#> Elapsed: 1m 6s | ETA: 12s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1650/2000 (82.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1737/2000 (86.9%)
...
#> 2    loose_ends-entertain (pairwise) 0.01625 0.1264355 0.002126457
#> 3   loose_ends-repetitive (pairwise) 0.03425 0.1818707 0.003630867
#> 4  loose_ends-stimulation (pairwise) 0.23300 0.4227422 0.016919129
#> 5    loose_ends-motivated (pairwise) 0.02750 0.1635352 0.003184783
#> 6                   entertain (main) 1.00000 0.0000000          NA
#> 7    entertain-repetitive (pairwise) 0.03200 0.1760000 0.003590335
#> 8   entertain-stimulation (pairwise) 0.17125 0.3767273 0.016649364
#> 9     entertain-motivated (pairwise) 0.06950 0.2543025 0.007693223
#> 10                 repetitive (main) 1.00000 0.0000000          NA
#> 11 repetitive-stimulation (pairwise) 0.03025 0.1712745 0.003838123
#> 12   repetitive-motivated (pairwise) 0.02375 0.1522693 0.003526196
#> 13                stimulation (main) 1.00000 0.0000000          NA
#> 14  stimulation-motivated (pairwise) 0.02025 0.1408543 0.002605743
#> 15                  motivated (main) 1.00000 0.0000000          NA
#>    n0->0 n0->1 n1->0 n1->1     n_eff     Rhat
#> 1      0     0     0  3999        NA       NA
#> 2   3874    60    60     5 3535.2881 1.007489
#> 3   3760   102   102    35 2509.0221 1.008913
#> 4   2874   193   193   739  624.3028 1.004247
#> 5   3804    85    85    25 2636.7118 1.002416
#> 6      0     0     0  3999        NA       NA
#> 7   3778    93    93    35 2403.0084 1.001110
#> 8   3186   128   129   556  511.9869 1.004298
#> 9   3610   111   111   167 1092.6586 1.029813
#> 10     0     0     0  3999        NA       NA
#> 11  3800    78    78    43 1991.3495 1.022953
#> 12  3846    58    59    36 1864.7122 1.022367
#> 13     0     0     0  3999        NA       NA
#> 14  3851    67    67    14 2921.9784 1.012131
#> 15     0     0     0  3999        NA       NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.94882319 -0.9069634
#> loose_ends(c2)  -2.74013677 -2.2363861
#> loose_ends(c3)  -4.00627944 -3.5500306
#> loose_ends(c4)  -5.31130691 -4.8217047
#> loose_ends(c5)  -7.61017952 -7.4082438
#> loose_ends(c6)  -9.83610220 -9.9376120
#> entertain(c1)   -0.75004277 -1.0404840
#> entertain(c2)   -2.19973968 -2.2792605
#> entertain(c3)   -3.99748882 -3.6930528
#> entertain(c4)   -5.07012128 -5.1785598
#> entertain(c5)   -7.04525499 -6.9799883
#> entertain(c6)   -9.71249240 -9.4627724
#> repetitive(c1)  -0.04755296 -0.2762815
#> repetitive(c2)  -0.49472144 -0.9137807
#> repetitive(c3)  -1.02828699 -1.1301902
#> repetitive(c4)  -1.95461972 -1.7247143
#> repetitive(c5)  -3.55488410 -2.9639005
#> repetitive(c6)  -5.28299663 -4.6783530
#> stimulation(c1) -0.35169885 -0.8564581
#> stimulation(c2) -1.75818607 -1.8556248
#> stimulation(c3) -2.44751616 -2.6794685
#> stimulation(c4) -3.42715280 -3.8575790
#> stimulation(c5) -5.05311777 -5.2974571
#> stimulation(c6) -6.73115259 -7.3993654
#> motivated(c1)   -0.46175182 -0.7044827
#> motivated(c2)   -1.74452747 -1.8685936
#> motivated(c3)   -3.42128834 -3.1583673
#> motivated(c4)   -5.04947426 -4.5792402
#> motivated(c5)   -6.62754228 -6.6847897
#> motivated(c6)   -9.29848227 -8.9015400

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16905251 0.16921108
#> loose_ends-repetitive  0.05669153 0.05751032
#> loose_ends-stimulation 0.12216710 0.13332768
#> loose_ends-motivated   0.14016624 0.13953571
#> entertain-repetitive   0.06427828 0.06489905
#> entertain-stimulation  0.10502025 0.11289060
#> entertain-motivated    0.08406014 0.08632635
#> repetitive-stimulation 0.05585910 0.05649069
#> repetitive-motivated   0.13454192 0.13501361
#> stimulation-motivated  0.10767351 0.10805151
# }
```
