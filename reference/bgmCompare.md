...
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2179/4000 (54.5%)
#> Elapsed: 11s | ETA: 9s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1150/2000 (57.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1230/2000 (61.5%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2380/4000 (59.5%)
#> Elapsed: 11s | ETA: 7s
...
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1436/2000 (71.8%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2786/4000 (69.7%)
#> Elapsed: 13s | ETA: 6s
...
#> 2    loose_ends-entertain (pairwise) 0.0175 0.1311249 0.003143171
#> 3   loose_ends-repetitive (pairwise) 0.0295 0.1692033 0.004879384
#> 4  loose_ends-stimulation (pairwise) 0.1420 0.3490501 0.027634779
#> 5    loose_ends-motivated (pairwise) 0.0245 0.1545954 0.004761066
#> 6                   entertain (main) 1.0000 0.0000000          NA
#> 7    entertain-repetitive (pairwise) 0.0185 0.1347507 0.003301968
#> 8   entertain-stimulation (pairwise) 0.1970 0.3977323 0.022273466
#> 9     entertain-motivated (pairwise) 0.0400 0.1959592 0.005784614
#> 10                 repetitive (main) 1.0000 0.0000000          NA
#> 11 repetitive-stimulation (pairwise) 0.0420 0.2005891 0.007548012
#> 12   repetitive-motivated (pairwise) 0.0225 0.1483029 0.003892316
#> 13                stimulation (main) 1.0000 0.0000000          NA
#> 14  stimulation-motivated (pairwise) 0.0245 0.1545954 0.003989122
#> 15                  motivated (main) 1.0000 0.0000000          NA
#>    n0->0 n0->1 n1->0 n1->1     n_eff      Rhat
#> 1      0     0     0  1999        NA        NA
#> 2   1932    32    32     3 1740.3417 1.0032184
#> 3   1897    43    43    16 1202.5069 0.9996479
#> 4   1679    36    36   248  159.5378 1.1251908
#> 5   1917    33    33    16 1054.3502 1.0098131
#> 6      0     0     0  1999        NA        NA
#> 7   1929    33    33     4 1665.3918 0.9998717
#> 8   1518    87    87   307  318.8645 1.0005765
#> 9   1863    56    56    24 1147.5786 1.0024220
#> 10     0     0     0  1999        NA        NA
#> 11  1873    42    42    42  706.2356 0.9997960
#> 12  1917    37    37     8 1451.7209 1.0057600
#> 13     0     0     0  1999        NA        NA
#> 14  1909    41    41     8 1501.8920 1.0163927
#> 15     0     0     0  1999        NA        NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.94586300 -0.9082024
#> loose_ends(c2)  -2.73952318 -2.2272371
#> loose_ends(c3)  -4.01113749 -3.5234979
#> loose_ends(c4)  -5.31515722 -4.7900464
#> loose_ends(c5)  -7.61622503 -7.3623675
#> loose_ends(c6)  -9.85501606 -9.8695025
#> entertain(c1)   -0.74644880 -1.0377626
#> entertain(c2)   -2.19363479 -2.2774812
#> entertain(c3)   -3.99382356 -3.6907419
#> entertain(c4)   -5.07097610 -5.1727048
#> entertain(c5)   -7.04023067 -6.9665202
#> entertain(c6)   -9.69733957 -9.4540382
#> repetitive(c1)  -0.05366407 -0.2760259
#> repetitive(c2)  -0.50103551 -0.9138419
#> repetitive(c3)  -1.03484134 -1.1302543
#> repetitive(c4)  -1.96240714 -1.7221921
#> repetitive(c5)  -3.55832225 -2.9520935
#> repetitive(c6)  -5.28401299 -4.6655377
#> stimulation(c1) -0.35017472 -0.8660525
#> stimulation(c2) -1.76377544 -1.8666290
#> stimulation(c3) -2.45327925 -2.6892141
#> stimulation(c4) -3.43300499 -3.8655763
#> stimulation(c5) -5.07970017 -5.3001044
#> stimulation(c6) -6.75409524 -7.4088581
#> motivated(c1)   -0.45744234 -0.7064321
#> motivated(c2)   -1.74223032 -1.8698246
#> motivated(c3)   -3.41436756 -3.1528730
#> motivated(c4)   -5.05164129 -4.5723303
#> motivated(c5)   -6.62412889 -6.6733272
#> motivated(c6)   -9.29102854 -8.8848908

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16926803 0.16930047
#> loose_ends-repetitive  0.05615861 0.05684433
#> loose_ends-stimulation 0.12403116 0.13080873
#> loose_ends-motivated   0.13987774 0.13926362
#> entertain-repetitive   0.06388993 0.06415049
#> entertain-stimulation  0.10465741 0.11375551
#> entertain-motivated    0.08438670 0.08545124
#> repetitive-stimulation 0.05646612 0.05741433
#> repetitive-motivated   0.13456059 0.13487583
#> stimulation-motivated  0.10783840 0.10824881
# }
```
