...
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━⦘ 1362/2000 (68.1%)
...
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━⦘ 1405/2000 (70.2%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1231/2000 (61.6%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━⦘ 5063/8000 (63.3%)
#> Elapsed: 54s | ETA: 31s
...
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1328/2000 (66.4%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━⦘ 5453/8000 (68.2%)
#> Elapsed: 56s | ETA: 26s
...
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━⦘ 1524/2000 (76.2%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━⦘ 6223/8000 (77.8%)
#> Elapsed: 59s | ETA: 17s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1700/2000 (85.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1426/2000 (71.3%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1734/2000 (86.7%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━⦘ 1575/2000 (78.8%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━⦘ 6435/8000 (80.4%)
#> Elapsed: 1m | ETA: 15s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1750/2000 (87.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━⦘ 1471/2000 (73.6%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━⦘ 1774/2000 (88.7%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━⦘ 1619/2000 (81.0%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━⦘ 6614/8000 (82.7%)
...
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 7180/8000 (89.8%)
#> Elapsed: 1m 4s | ETA: 7s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1950/2000 (97.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━⦘ 1663/2000 (83.2%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺⦘ 1961/2000 (98.0%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1800/2000 (90.0%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 7374/8000 (92.2%)
#> Elapsed: 1m 4s | ETA: 5s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━⦘ 1715/2000 (85.8%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1845/2000 (92.2%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 7560/8000 (94.5%)
#> Elapsed: 1m 5s | ETA: 4s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Chain 3 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Chain 4 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2000/2000 (100.0%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 8000/8000 (100.0%)
#> Elapsed: 1m 8s | ETA: 0s

# Posterior inclusion probabilities
summary(fit)$indicator
#>                            parameter    mean        sd        mcse
#> 1                  loose_ends (main) 1.00000 0.0000000          NA
#> 2    loose_ends-entertain (pairwise) 0.01975 0.1391400 0.002391215
#> 3   loose_ends-repetitive (pairwise) 0.03350 0.1799382 0.003833393
#> 4  loose_ends-stimulation (pairwise) 0.21425 0.4103010 0.015701070
#> 5    loose_ends-motivated (pairwise) 0.02425 0.1538244 0.003104327
#> 6                   entertain (main) 1.00000 0.0000000          NA
#> 7    entertain-repetitive (pairwise) 0.02600 0.1591352 0.003147135
#> 8   entertain-stimulation (pairwise) 0.19975 0.3998124 0.020834351
#> 9     entertain-motivated (pairwise) 0.04550 0.2083981 0.004726226
#> 10                 repetitive (main) 1.00000 0.0000000          NA
#> 11 repetitive-stimulation (pairwise) 0.02950 0.1692033 0.003294994
#> 12   repetitive-motivated (pairwise) 0.03075 0.1726396 0.004150159
#> 13                stimulation (main) 1.00000 0.0000000          NA
#> 14  stimulation-motivated (pairwise) 0.02250 0.1483029 0.002720445
#> 15                  motivated (main) 1.00000 0.0000000          NA
#>    n0->0 n0->1 n1->0 n1->1     n_eff     Rhat
#> 1      0     0     0  3999        NA       NA
#> 2   3849    71    71     8 3385.8409 1.007450
#> 3   3773    92    92    42 2203.3322 1.008491
#> 4   2946   197   196   660  682.8837 1.003684
#> 5   3830    72    72    25 2455.3618 1.019622
#> 6      0     0     0  3999        NA       NA
#> 7   3816    79    79    25 2556.8278 1.005972
#> 8   3093   107   108   691  368.2583 1.040890
#> 9   3704   114   113    68 1944.2781 1.005953
#> 10     0     0     0  3999        NA       NA
#> 11  3790    91    91    27 2636.9883 1.000075
#> 12  3804    72    72    51 1730.4197 1.011108
#> 13     0     0     0  3999        NA       NA
#> 14  3834    75    75    15 2971.7980 1.015818
#> 15     0     0     0  3999        NA       NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.94918323 -0.9098268
#> loose_ends(c2)  -2.74356728 -2.2384571
#> loose_ends(c3)  -4.01116934 -3.5497669
#> loose_ends(c4)  -5.31401701 -4.8217572
#> loose_ends(c5)  -7.61888965 -7.4085478
#> loose_ends(c6)  -9.84927648 -9.9325795
#> entertain(c1)   -0.74803072 -1.0385807
#> entertain(c2)   -2.19279506 -2.2755000
#> entertain(c3)   -3.98762921 -3.6859254
#> entertain(c4)   -5.05425038 -5.1680406
#> entertain(c5)   -7.02469573 -6.9644259
#> entertain(c6)   -9.68845562 -9.4469362
#> repetitive(c1)  -0.04378962 -0.2812373
#> repetitive(c2)  -0.49584131 -0.9176452
#> repetitive(c3)  -1.02754525 -1.1389604
#> repetitive(c4)  -1.95823948 -1.7320398
#> repetitive(c5)  -3.56021822 -2.9656653
#> repetitive(c6)  -5.28659541 -4.6894087
#> stimulation(c1) -0.35311385 -0.8601651
#> stimulation(c2) -1.75969565 -1.8574168
#> stimulation(c3) -2.44424759 -2.6826478
#> stimulation(c4) -3.42500664 -3.8625404
#> stimulation(c5) -5.05458954 -5.3015895
#> stimulation(c6) -6.72046666 -7.4062391
#> motivated(c1)   -0.45947149 -0.7066657
#> motivated(c2)   -1.74121797 -1.8716134
#> motivated(c3)   -3.42217347 -3.1604135
#> motivated(c4)   -5.05572573 -4.5880202
#> motivated(c5)   -6.63653612 -6.6912629
#> motivated(c6)   -9.30480329 -8.9043937

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16924340 0.16929500
#> loose_ends-repetitive  0.05665926 0.05762731
#> loose_ends-stimulation 0.12267205 0.13299638
#> loose_ends-motivated   0.14012373 0.13961775
#> entertain-repetitive   0.06379790 0.06430301
#> entertain-stimulation  0.10376942 0.11317391
#> entertain-motivated    0.08437109 0.08571396
#> repetitive-stimulation 0.05612240 0.05673552
#> repetitive-motivated   0.13460142 0.13532724
#> stimulation-motivated  0.10771625 0.10807271
# }
```
