...
- delta:
  ...
  Non-negative numeric. Determinant-tilt exponent on the
  continuous-block precision matrix \\K\\ (GGM) or \\K\_{yy}\\ (mixed
  MRF): multiplies the prior by \\\|K\|^{\delta}\\, pushing the chain
  away from the positive-definite cone boundary. Both NUTS and
  adaptive-Metropolis update paths apply the tilt. `delta = 0` (default)
  recovers the untilted prior. Not allowed for pure ordinal models (no
  precision matrix to tilt).
...
#> Total   (Warmup): ⦗━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 452/8000 (5.7%)
#> Elapsed: 2s | ETA: 33s
#> Chain 1 (Warmup): ⦗━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 450/4000 (11.2%)
#> Chain 2 (Warmup): ⦗━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 408/4000 (10.2%)
#> Total   (Warmup): ⦗━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 858/8000 (10.7%)
#> Elapsed: 3s | ETA: 25s
#> Chain 1 (Warmup): ⦗━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 650/4000 (16.2%)
#> Chain 2 (Warmup): ⦗━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 606/4000 (15.2%)
#> Total   (Warmup): ⦗━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1256/8000 (15.7%)
#> Elapsed: 4s | ETA: 21s
