...
Retrieves posterior samples of baseline pairwise interaction parameters
from a model fitted with \[bgmCompare()\].
...
containing posterior samples of baseline interaction strengths.
