...
Computes the posterior probability of difference inclusion from a model
...
A symmetric p x p matrix where diagonal entries are main-effect
inclusion probabilities and off-diagonal entries are pairwise difference
