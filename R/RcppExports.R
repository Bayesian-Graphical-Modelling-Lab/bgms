...
sd_log_density_at_l_ji_aghq_cpp <- function(x_eval, A, B, s_jj, alpha, num_nodes = 32L) {
    .Call(`_bgms_sd_log_density_at_l_ji_aghq_cpp`, x_eval, A, B, s_jj, alpha, num_nodes)
}
