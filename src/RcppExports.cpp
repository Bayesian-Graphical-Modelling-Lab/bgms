...
// sample_ggm
Rcpp::List sample_ggm(const Rcpp::List& inputFromR, const arma::mat& prior_inclusion_prob, const arma::imat& initial_edge_indicators, const int no_iter, const int no_warmup, const int no_chains, const bool edge_selection, const std::string& sampler_type, const int seed, const int no_threads, const int progress_type, SEXP progress_callback, const std::string& edge_prior, const double beta_bernoulli_alpha, const double beta_bernoulli_beta, const double beta_bernoulli_alpha_between, const double beta_bernoulli_beta_between, const double dirichlet_alpha, const double lambda, const double target_acceptance, const int max_tree_depth, const bool na_impute, const Rcpp::Nullable<Rcpp::IntegerMatrix> missing_index_nullable, const double delta, const std::string& gg_hyperprior, const double gg_a0, const double gg_b0, const double gg_tcch_r, const double gg_tcch_s, const double gg_tcch_u, const double gg_g_fixed, const double gg_g_init, const bool prior_only, const Rcpp::Nullable<Rcpp::NumericMatrix> V_ij_external_nullable);
RcppExport SEXP _bgms_sample_ggm(SEXP inputFromRSEXP, SEXP prior_inclusion_probSEXP, SEXP initial_edge_indicatorsSEXP, SEXP no_iterSEXP, SEXP no_warmupSEXP, SEXP no_chainsSEXP, SEXP edge_selectionSEXP, SEXP sampler_typeSEXP, SEXP seedSEXP, SEXP no_threadsSEXP, SEXP progress_typeSEXP, SEXP progress_callbackSEXP, SEXP edge_priorSEXP, SEXP beta_bernoulli_alphaSEXP, SEXP beta_bernoulli_betaSEXP, SEXP beta_bernoulli_alpha_betweenSEXP, SEXP beta_bernoulli_beta_betweenSEXP, SEXP dirichlet_alphaSEXP, SEXP lambdaSEXP, SEXP target_acceptanceSEXP, SEXP max_tree_depthSEXP, SEXP na_imputeSEXP, SEXP missing_index_nullableSEXP, SEXP deltaSEXP, SEXP gg_hyperpriorSEXP, SEXP gg_a0SEXP, SEXP gg_b0SEXP, SEXP gg_tcch_rSEXP, SEXP gg_tcch_sSEXP, SEXP gg_tcch_uSEXP, SEXP gg_g_fixedSEXP, SEXP gg_g_initSEXP, SEXP prior_onlySEXP, SEXP V_ij_external_nullableSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const std::string& >::type gg_hyperprior(gg_hyperpriorSEXP);
    Rcpp::traits::input_parameter< const double >::type gg_a0(gg_a0SEXP);
    Rcpp::traits::input_parameter< const double >::type gg_b0(gg_b0SEXP);
    Rcpp::traits::input_parameter< const double >::type gg_tcch_r(gg_tcch_rSEXP);
    Rcpp::traits::input_parameter< const double >::type gg_tcch_s(gg_tcch_sSEXP);
    Rcpp::traits::input_parameter< const double >::type gg_tcch_u(gg_tcch_uSEXP);
    Rcpp::traits::input_parameter< const double >::type gg_g_fixed(gg_g_fixedSEXP);
    Rcpp::traits::input_parameter< const double >::type gg_g_init(gg_g_initSEXP);
    Rcpp::traits::input_parameter< const bool >::type prior_only(prior_onlySEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::NumericMatrix> >::type V_ij_external_nullable(V_ij_external_nullableSEXP);
    rcpp_result_gen = Rcpp::wrap(sample_ggm(inputFromR, prior_inclusion_prob, initial_edge_indicators, no_iter, no_warmup, no_chains, edge_selection, sampler_type, seed, no_threads, progress_type, progress_callback, edge_prior, beta_bernoulli_alpha, beta_bernoulli_beta, beta_bernoulli_alpha_between, beta_bernoulli_beta_between, dirichlet_alpha, lambda, target_acceptance, max_tree_depth, na_impute, missing_index_nullable, delta, gg_hyperprior, gg_a0, gg_b0, gg_tcch_r, gg_tcch_s, gg_tcch_u, gg_g_fixed, gg_g_init, prior_only, V_ij_external_nullable));
    return rcpp_result_gen;
END_RCPP
}
// sample_mixed_mrf
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bgms_sample_ggm", (DL_FUNC) &_bgms_sample_ggm, 34},
